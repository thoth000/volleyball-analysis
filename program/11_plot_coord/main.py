  ...
  with open(file) as f:
    ...
    for person in data:
      ...
      if data[person]["position_x"] > 9000:
        ax.text(x, data[person]["position_y"], id, size=textsize, horizontalalignment="center", verticalalignment="center", color="red", fontweight="bold")
      else:
        ax.text(x, data[person]["position_y"], id, size=textsize, horizontalalignment="center", verticalalignment="center", color="blue", fontweight="bold")
